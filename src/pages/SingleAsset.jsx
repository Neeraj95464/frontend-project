...
//     const handleAssetClick = (assetTagId, assetSummary) => {
...
//             <div 
//       key={asset.id}
//       onClick={() => handleAssetClick(asset.assetTagId, {
//         description: asset.description,
//         brand: asset.brand,
//         model: asset.model,
//         serialNo: asset.serialNo,
//         currentStatus: asset.newStatus,
//         bookValue: asset.bookValue,
//       })}
//       className="cursor-pointer hover:shadow-lg transition-shadow p-4 border rounded-lg"
//     >
//       <h3 className="font-semibold">{asset.assetTagId}</h3>
