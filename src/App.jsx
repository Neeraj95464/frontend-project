...
//   return (
//     <Router>
//       {/* App wrapper with responsive classes */}
...
//           <div className={`${isMobile ? 'fixed z-50' : 'relative'} ${isMobile && !isMobileMenuOpen ? 'hidden' : 'block'}`}>
//             <Sidebar />
//           </div>

//           {/* Main content area - responsive padding */}
//           <div className={`flex-1 transition-all duration-300 ${isMobile ? 'p-2' : 'p-4'}`}>
//             <div className="h-full bg-white rounded-lg shadow-lg flex flex-col min-h-0 overflow-x-auto">
//               <Routes>
//                 {/* Public Routes */}
//                 <Route path="/login" element={<Login />} />
//                 <Route path="/register" element={<Register />} />
...
//       {/* Global Toasts - Responsive position */}
//       <ToastContainer 
//         position="top-right" 
//         autoClose={3000}
