...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* SIDEBAR */}
      {/* <aside
        className={`fixed top-16 left-0 h-[calc(100vh-4rem)] w-56 bg-gray-800 text-white transform ${
          isOpen ? "translate-x-0" : "-translate-x-full"
        } transition-transform lg:translate-x-0 flex flex-col justify-between shadow-lg`}
      > */}
      {/* <aside
  className={`fixed top-16 left-0 h-[calc(100vh-4rem)] w-52 bg-gray-800 text-white transform ${
    isOpen ? "translate-x-0" : "-translate-x-full"
  } transition-transform lg:translate-x-0 flex flex-col justify-between shadow-lg`}
> */}
