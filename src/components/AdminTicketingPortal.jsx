...
// //           {/* Table Section - Moved to Child Component */}
// //           {/* <TicketTable
// //             tickets={filteredTickets}
// //             loading={loading}
// //             userRole={userRole}
// //             onRefresh={fetchTicketsWithFilters}
// //           /> */}

// //           {/* Table Section - scroll only here */}
...
//           {/* Filters Section */}
//           <div className="border-b border-gray-200 bg-gray-50 overflow-x-hidden">
//             <div className="px-6 py-4">
//               <button
//                 onClick={() => setShowFilters(!showFilters)}
//                 className="flex items-center gap-2 text-gray-700 hover:text-blue-600 font-medium transition-colors"
...
//                     <Button
//                       onClick={handleDownloadTickets}
//                       className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold shadow-lg transition-all"
//                       disabled={loading}
//                     >
//                       📥 Download
//                     </Button>
